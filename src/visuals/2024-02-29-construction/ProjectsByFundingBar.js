  ...
  return (
    <div>
      ...
      <div className="fund-data-note-div">
        <p style={{ marginTop: 0 }}>
          <b> About the data:</b>This visualization includes projects with permits that were approved between Jan. 2019 and Dec. 2022. It does not include permits for additions or modifications.
        </p>
      </div>
    </div>
  );
